...
const Home = () => {
    return (
        <>
                        ...
                        <div>
                            <div className="lg:w-[570px]">
                                ...
                                <p className="text__para">
                                    ...
                                    Totam similique accusantium voluptatum quasi iusto autem
                                    saepe? Accusantium minima eum voluptas maiores totam quisquam,
                                    enim facere, impedit debitis, doloremque aut accusamus.
                                </p>
                ...
                <div className="container">
                    <div className="xl:w-[470px] mx-auto">
                        ...
                        <p className="text__para text-center">
                            ...
                            perspiciatis corrupti ut soluta?
                        </p>
                    </div>
                    ...
                    <div className="flex items-center justify-between flex-col lg:flex-row">
                        ...
                        <div className="xl:w-[670px]">
                            <h2 className="heading">
                                Get free consultation before book a service <br /> anytime
                            </h2>
                            <ul className="pl-4">
            ...
            {/*======== our great service provider ========= */}
            <section>
                <div className="container">
                    <div className="xl:w-[470px] mx-auto">
                        <h2 className="heading text-center">Our Great Service Provider </h2>
                        <p className="text__para text-center">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus
                            perspiciatis corrupti ut soluta?
                        </p>
